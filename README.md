...
<p style="text-align:left">Welcome to my page. I'm Ata Can, and I'm delighted to have you here.<br><br>This page is a space where I share my thoughts, projects, and ideas with the world. Whether you're here out of curiosity, interest, or just passing by, I hope you find something that resonates with you.<br><br>Feel free to explore the content, engage with the community, and reach out if you have any questions or simply want to connect.</p>

---

<div style="text-align:center">
  <a href="https://github.com/AtaCanYmc">
    <img src="https://avatars.githubusercontent.com/u/78666296?s=400&u=a896ad1753fd963a1f04031d566e83d1819acfc3&v=4" width="140" alt="avatar" />
  </a>

  <h2>Ata Can YAYMACI</h2>
  <p>Full‑stack Software Developer • Enterprise & modern web technologies</p>

  <p>
    <a href="https://www.linkedin.com/in/ata-can-yaymacı/" target="_blank">🔗 LinkedIn</a>
    &nbsp; • &nbsp;
    <a href="https://medium.com/@atacanymc" target="_blank">✍️ Medium</a>
    &nbsp; • &nbsp;
...
- Arduino (C++) & IoT projects for hardware/software integration
- Machine learning concepts and practical applications

My goal is to combine enterprise-grade development experience with modern technologies to create efficient, high-quality, and innovative solutions. I enjoy solving complex problems, writing clean code, and staying up to date with evolving software practices.
...
- [izmir-afet-toplanma-alanlari](https://github.com/AtaCanYmc/izmir-afet-toplanma-alanlari) — İzmir'deki acil toplama alanlarını canlı harita üzerinde görüntüleyebileceğiniz, arama yapabileceğiniz ve yol tarifi alabileceğiniz web uygulaması.
- [RemoteStation](https://github.com/AtaCanYmc/RemoteStation) — This Arduino Leonardo project enables remote control functionality for the PlayStation 4 using an infrared (IR) remote. With this setup, you can easily navigate through various media applications on the PlayStation 4, including movies, TV shows, and music. Additionally, the remote control can be connected to a computer for extended functionality.
- [Game-Tree-Solver](https://github.com/AtaCanYmc/Game-Tree-Solver) — Game Tree Solver for Artificial Intelligence Class
...
<div style="text-align:center">
  <img src="https://github-readme-stats.vercel.app/api?username=AtaCanYmc&show_icons=true&theme=dracula&hide_border=false" alt="AtaCan's GitHub stats" />
  <img src="https://github-readme-streak-stats.herokuapp.com/?user=AtaCanYmc&theme=dracula&hide_border=false" alt="streak stats" />
</div>
